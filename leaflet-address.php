...
class LeafletAddressPlugin extends Plugin
{
    ...
    public function onAssetsInitialized(Event $e)
    {
        ...
        if ($this->config->get('plugins.' . self::NAME . '.cdn')) {
            ...
            array_push($commonCollection, "//unpkg.com/leaflet@1.4.0/dist/leaflet.min.js");
        } else {
            array_push($commonCollection, "plugin://" . self::NAME . "/assets/css/leaflet.css");
            array_push($commonCollection, "plugin://" . self::NAME . "/assets/js/leaflet.min.js");
        }
        array_push($commonCollection, "plugin://" . self::NAME . "/assets/js/leaflet-address.frontend.min.js");
        ...
        array_push($backendCollection, "plugin://" . self::NAME . "/assets/js/leaflet-address.backend.min.js");
